  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>Gagnez jusqu'à 10 000 zł/mois en rejoignant notre équipe en tant que<br><span><a href="#partners" style="color: #DECE31;">driver</a></span></h2>
        <a href="#why-us" class="btn-get-started scrollto">Continuer <i class="fa fa-chevron-down" aria-hidden="true"></i> </a>
      </div>
      ...
      <div class="container">
        <header class="section-header">
          ...
          <p><span style="color: #DECE31;">SUN WORK</span>
            Rejoignez-nous pour une carrière enrichissante ! Profitez d'une flexibilité exceptionnelle, d'une communauté solidaire et de nombreux avantages. Découvrez pourquoi nous choisir comme partenaire de confiance !
          </p>
        </header>
        ...
        <div class="row row-eq-height justify-content-center">
          <div class="col-lg-4 mb-4">
            <div class="card wow bounceInUp">
              ...
              <div class="card-body">
                <h5 class="card-title text-white">Service de qualité</h5>
                <p class="card-text">>Nous vous offrons un service de qualité pour toutes vos démarches, que ce soit pour votre recherche d'emploi ou vos démarches administratives.</p>
          ...
          <div class="col-lg-4 mb-4">
            <div class="card wow bounceInUp">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Grâce à son service international, SUN WORK vous propose un accompagnement en Pologne mais aussi depuis l'étranger.</p>
                <!-- <a href="#" class="readmore">Read more </a> -->
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 mb-4">
            <div class="card wow bounceInUp">
              ...
              <div class="card-body">
                <h5 class="card-title text-white">Confidentialité</h5>
                <p class="card-text">Dans le cadre du respect de votre vie privée, nous vous garantissons une confidentialité totale dans toutes vos démarches. </p>
                <!-- <a href="#" class="readmore">Read more </a> -->
              </div>
            </div>
          </div>
    ...
    <section id="partners" class="section-bg">
      ...
      <div class="container">
        ...
        <div class="section-header">
          ...
          <p>
            Nous sommes fiers de collaborer avec des partenaires de confiance qui partagent notre vision et nos valeurs. Grâce à leur expertise et à leur soutien, nous améliorons l'expérience de nos utilisateurs et renforçons notre engagement envers l'excellence. Découvrez nos partenaires et rejoignez-nous dans notre mission : offrir les meilleurs produits et services à notre communauté.
          </p>
        </div>
      ...
      <div class="accordion">
        ...
        <div class="accordion-text">
          ...
          <ul class="faq-text">
            <li>
              <div class="question-arrow">
                <span class="question">Que fait SUN WORK ?</span>
                <i class="bx bxs-chevron-down arrow"></i>
              </div>
              <p>SUN WORK est une entreprise 100% polonaise, qui vous accompagne dans votre recherche d'emploi et vos démarches administratives.</p>
              <span class="line"></span>
            </li>
            <li>
              <div class="question-arrow">
                <span class="question">Quelles exigences Bolt/Uber devons-nous respecter ?</span>
                <i class="bx bxs-chevron-down arrow"></i>
              </div>
              <p>
                <strong>Vehicules</strong>: Moins de 10 ans, 4 portes (berline ou SUV), en bon état. </br>
                <strong>Vehicules documents</strong>: Carte grise, assurance professionnelle, contrôle technique à jour.</br>
                <strong>Driver</strong>: Permis de conduire valide, casier judiciaire vierge.</br>
                <strong>License</strong>: Licence de taxi .</br>
                <strong>Taxation</strong>: Immatriculation fiscale en tant qu'entrepreneur ou via une entreprise partenaire (ce que nous sommes).
              </p>
              <span class="line"></span>
            </li>
            <li>
              <div class="question-arrow">
                <span class="question">Quel sera mon salaire et quand le recevrai-je ?</span>
                <i class="bx bxs-chevron-down arrow"></i>
              </div>
              <p>Votre salaire est relativement lié à votre façon de travailler et peut atteindre jusqu'à 10 000 zlotys par mois.</p>
              <span class="line"></span>
            </li>
            <li>
              <div class="question-arrow">
                <span class="question">Je suis étudiant, puis-je travailler pour SUN WORK ?</span>
                <i class="bx bxs-chevron-down arrow"></i>
              </div>
              <p>Bien sûr, nous pouvons être un partenaire.</p>
              <span class="line"></span>
            </li>
            <li>
              <div class="question-arrow">
                <span class="question">Est-ce que travailler via l'application est légal ?</span>
                <i class="bx bxs-chevron-down arrow"></i>
              </div>
              <p>Nous travaillons en toute légalité.</p>
              <span class="line"></span>
            </li>
          </ul>
          <div class="col-lg-5 mb-4">
            <div class="card wow bounceInUp">
              <div class="card-body">
                <a href="/faq-sunwork" class="readmore">En savoir plus <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>
        </div>
