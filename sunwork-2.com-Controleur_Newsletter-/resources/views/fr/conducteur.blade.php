    ...
    <main id="main">
        <section id="about">
            <div class="container">
                ...
                <header class="section-header">
                    ...
                    <p>N'attendez plus, rejoignez-nous en tant que chauffeurs ou livreurs </p>
                </header>
                ...
                <div class="row about-container">
                    ...
                    <div class="col-lg-6 content order-lg-1 order-2 order-text">
                        <p>
                            <b>
                                <h5>Gagnez à partir de 2 500 zł par semaine en taxi ou en livraison.</h5>
                            </b>
                            <br>
                            Travaillez sur votre propre véhicule ou sur des voitures de luxe modernes, haut de gamme ou de collection, sans avoir à payer de caution. En tant que professionnel de l'automobile, vous aurez l'opportunité d'effectuer diverses tâches, des réparations mécaniques de base aux ajouts de fonctionnalités haut de gamme, en passant par des services d'entretien avancés tels que la mise au point du moteur et le diagnostic électronique. De plus, en travaillant sur ces véhicules prestigieux, vous développerez une expertise précieuse et une compréhension approfondie des technologies automobiles modernes.
                            En outre, en tant que technicien automobile indépendant, vous bénéficierez d'une rémunération régulière et prévisible, avec des versements hebdomadaires.
                ...
                <div class="text-center">
                    <header class="section-header">
                        <h3>Avantages de travailler avec nous</h3>
                    </header>
                </div>
                <br>
                <div class="row about-container">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="icon-box wow fadeInUp order-text">
                            ...
                            <h4 class="title"><a href="">Voitures hybrides pour le travail</a></h4>
                            <p class="description">Aujourd'hui, conduisez en toute sérénité les voitures hybrides que nous mettons à votre disposition</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 order-text">
                        <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <h4 class="title"><a href="">Paiements hebdomadaires</a></h4>
                            <p class="description">Nous avons mis en place un système de paiement hebdomadaire pour les paiements d'argent</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 order-text">
                        <div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <h4 class="title"><a href="">Emploi officiel</a></h4>
                            <p class="description">Nous vous aidons à travailler avec nos partenaires officiels en Pologne</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="icon-box wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <h4 class="title"><a href="">Bonus supplémentaires</a></h4>
                            <p class="description">Augmentez vos gains avec des bonus que nous avons préparés spécialement pour vous</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="pricing">
            <div class="container" data-aos="fade-up">
                <div class="text-center">
                    <header class="section-header">
                        <h3>Exigences et horaire de travail </h3>
                    </header>
                </div>
                <br>
                <div class="container">
        ...
        <section id="pricing" class="pricing">
            <div class="container" data-aos="fade-up">
                ...
                <div class="text-center">
                    <header class="section-header">
                        <h3>Tarification</h3>
                        <p>Nous vous proposons nos différentes offres</p>
                    </header>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 align-items-center" data-aos="fade-up" data-aos-delay="100">
                        <div class="box">
                            <h3>Je veux devenir chauffeur</h3>
                            <h4><sup>ZŁ</sup>60<span>per week</span></h4>
                            <ul>
                                <li><i class="fa fa-check"></i> License de Taxi </li>
                                <li><i class="fa fa-check"></i> Payment tous les lundis</li>
                                <li><i class="fa fa-check"></i> Aide à l'inscription</li>
                            </ul>
                            <a href="" class="buy-btn" data-bs-toggle="modal" data-bs-target="#staticBackdropForDriver">Commencer</a>
                        </div>
                    </div>

                    <div class="col-lg-4 mt-4 mt-lg-0 align-items-center" data-aos="fade-up" data-aos-delay="300">
                        <div class="box">
                            <h3>Je veux devenir coursier</h3>
                            <h4><sup>ZŁ</sup>35<span>par semaine</span></h4>
                            <ul>
                                <li><i class="fa fa-check"></i> Sac isotherme</li>
                                <li><i class="fa fa-check"></i> Payment tous les lundis</li>
                                <li><i class="fa fa-check"></i> Aide à l'inscription</li>
                            </ul>
                            <a href="" class="buy-btn" data-bs-toggle="modal" data-bs-target="#staticBackdropForCourier">Commencer</a>
                        </div>
                    </div>
        ...
        <section id="about">
            <div class="all-div-carousel container-fluid">
                <div class="text-center">
                    <br>
                    <header class="section-header">
                        <h3>Flotte de véhicules pour le travail de taxi</h3>
                    </header>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('email-procedure') }}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="phone_number" class="form-label">Téléphone <one class="require">*</one></label>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="service" name="service" required>
                                ...
                                <option value="Drivers" selected>Deviens un conducteur</option>
                                <option value="Accommodation assistance">Aide au logement</option>
                                <option value="Work permit">Permis de travail</option>
                                <option value="Other requests">Autres demandes</option>
                            </select>
                        </div>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" required>
                            <label class="form-check-label" for="exampleCheck1"><object>J'ai lu et accepté la </object> <a href="/privacy-policy">Politique de confidentialité</a>. <one class="require">*</one></label>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('email-procedure') }}" method="post">
                        @csrf
                        <div class="card-title d-flex justify-content-between align-items-center">
                            <h1 class="modal-title fs-5 mx-auto" id="staticBackdropLabel">Faire une demande pour devenir <span style="color: #DECE31;">Conducteur</span></h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="mb-3">
                            <label for="city" class="form-label">Ville <one class="require">*</one></label>
                            <select class="form-select" aria-label="Default select example" id="city" name="city" required>
                                <option value="" disabled selected>-- Chosis ta ville --</option>
                                <option value="Varsovie">Varsovie</option>
                                <option value="Cracovie">Cracovie</option>
                                <option value="Wrocław">Wrocław</option>
                                <option value="Gdańsk">Gdańsk</option>
