    ...
    <section id="newsletter-section">
        <footer id="footer">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 footer-info">
                            <div>
                                ...
                                <p><b>Collaborating with us is a door to your development</b></p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-6 footer-links">
                            ...
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li><a href="/about-us-sunwork">About us</a></li>
                                <li><a href="/services-sunwork">Our Services</a></li>
                        ...
                        <div class="col-lg-3 col-md-6 footer-contact">
                            ...
                            <p>
                                ...
                                <strong>Phone:</strong> +48 729 682 370<br>
                        ...
                        <div class="col-lg-3 col-md-6 footer-newsletter">
                            ...
                            <p>Stay up to date with the latest news, special offers and trends by subscribing to our newsletter. Get exclusive content and subscriber-only benefits delivered straight to your inbox. Don't miss anything that's happening on <span style="color: #DECE31;">SUN WORK</span>. Subscribe now to stay connected!</p>
            ...
            <div class="container">
                ...
                <div class="credits">
                    Designed by <strong><span style="color: teal;">win-it</span></strong>
                </div>
            </div>
        </footer><!-- #footer -->
    </section>
